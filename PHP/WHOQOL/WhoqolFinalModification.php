<h4>Evaluation WHOQOL </h4> 
								...
								<div class="form-group">
								  <label class="col-md-4 control-label" >Comment évaluez-vous votre qualité de vie ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($eval_qualite_vie2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="QDV1-2" name="QDV1-2"  value="1" selected required="" > Très faible </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="QDV1-2" name="QDV1-2"  value="1" required="" > Très faible </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de votre santé ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($satisfaction_sante2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="QDV2-2" name="QDV2-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="QDV2-2" name="QDV2-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >La douleur physique vous empêche t'elle de faire ce dont vous avez envie ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($douleur_physique2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy1-2" name="SPhy1-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy1-2" name="SPhy1-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Avez-vous besoin d'un traitement médical quotidiennement ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($traitement_quotidien2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy2-2" name="SPhy2-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy2-2" name="SPhy2-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Aimez-vous votre vie ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($aimer_vie2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy1-2" name="SPsy1-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy1-2" name="SPsy1-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Estimez-vous que votre vie a du sens ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($sens_vie2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy2-2" name="SPsy2-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy2-2" name="SPsy2-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous capable de vous concentrer ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($concentration2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy3-2" name="SPsy3-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy3-2" name="SPsy3-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Vous sentez-vous en sécurité dans votre vie quotidienne ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($securite_vie2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv1-2" name="SEnv1-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv1-2" name="SEnv1-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Viviez-vous dans un environnement sain ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									<?php 
								if($environnement_sain2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv2-2" name="SEnv2-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv2-2" name="SEnv2-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Avez-vous assez d'énergie dans votre vie quotidienne ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($energie_vie2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy3-2" name="SPhy3-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy3-2" name="SPhy3-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Acceptez-vous votre apparence physique ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($apparence2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy4-2" name="SPsy4-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy4-2" name="SPsy4-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Avez-vous assez d'argent pour satisfaire vos besoins ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($argent2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv3-2" name="SEnv3-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv3-2" name="SEnv3-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Avez-vous accès aux informations nécessaires pour votre vie quotidienne ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($acces_info_vie2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv4-2" name="SEnv4-2"  value="1" selected  required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv4-2" name="SEnv4-2"  value="1"  required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Avez-vous souvent l'occasion de pratiquer des loisirs ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($pratique_loisir2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv5-2" name="SEnv5-2"  value="1" selected required="" > Pas du tout </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv5-2" name="SEnv5-2"  value="1" required="" > Pas du tout </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Comment arrivez-vous à vous déplacer ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($deplacement2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy4-2" name="SPhy4-2"  value="1" selected required="" > Très difficilement </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy4-2" name="SPhy4-2"  value="1" required="" > Très difficilement </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de votre sommeil ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($sommeil2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy5-2" name="SPhy5-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy5-2" name="SPhy5-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de votre capacité à effectuer les tâches de la vie quotidienne ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($taches_vie2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy6-2" name="SPhy6-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy6-2" name="SPhy6-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de votre capacité à effectuer votre activité professionnelle ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($act_pro2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy7-2" name="SPhy7-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPhy7-2" name="SPhy7-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de vous ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($vous2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy5-2" name="SPsy5-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy5-2" name="SPsy5-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de vos relations avec les autres ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($relation2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SRel1-2" name="SRel1-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SRel1-2" name="SRel1-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de votre vie sexuelle ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($vie_sexuelle2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SRel2-2" name="SRel2-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SRel2-2" name="SRel2-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) du soutien de vos amis ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($amis_soutien2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SRel3-2" name="SRel3-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SRel3-2" name="SRel3-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de votre lieu de vie ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($lieu_vie2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv6-2" name="SEnv6-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv6-2" name="SEnv6-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de votre accès aux services de santé ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($acces_service2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv7-2" name="SEnv7-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv7-2" name="SEnv7-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Êtes-vous satisfait(e) de votre moyen de transport ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									<?php 
								if($moyen_transport2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv8-2" name="SEnv8-2"  value="1" selected required="" > Très insatisfait(e) </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SEnv8-2" name="SEnv8-2"  value="1" required="" > Très insatisfait(e) </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Avez-vous souvent des sentiments négatifs tels que la mélancolie, le désespoir, l'anxiété ou la dépression ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($sentiment_negatif2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy6-2" name="SPsy6-2"  value="1" selected required="" > Jamais </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="SPsy6-2" name="SPsy6-2"  value="1" required="" > Jamais </label>
