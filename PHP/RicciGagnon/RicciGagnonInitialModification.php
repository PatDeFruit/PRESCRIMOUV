<h4>Evaluation Ricci & Gagnon </h4> 
								...
								<?php 
								if($RG_CS == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="CS1" name="CS1"  value="1" selected  required="" > + 5h </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="CS1" name="CS1"  value="1"  required="" > + 5h </label>
								...
								<div class="col-md-8">
									<?php 
									if($RG_APL1 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL1" name="APL1"  value="1" onchange="masquer_div(\'freq-activite\');masquer_div(\'min-act\');masquer_div(\'perception-effort\');"  required="" > Non </label>
									<label for="default" class="btn btn-default"><input type="radio" id="APL1" name="APL1"  value="5" onchange="masquer_div(\'freq-activite\');masquer_div(\'min-act\');masquer_div(\'perception-effort\');"> Oui </label>';
								} else if($RG_APL1 == 5){
									echo'<label for="default" class="btn btn-default" ><input type="radio" id="APL1" name="APL1"  value="1" onchange="masquer_div(\'freq-activite\');masquer_div(\'min-act\');masquer_div(\'perception-effort\');"  required="" > Non </label>
									<label for="default" class="btn btn-default"><input type="radio" id="APL1" name="APL1"  value="5" selected onchange="masquer_div(\'freq-activite\');masquer_div(\'min-act\');masquer_div(\'perception-effort\');"> Oui </label>';
								} else {
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL1" name="APL1"  value="1" onchange="masquer_div(\'freq-activite\');masquer_div(\'min-act\');masquer_div(\'perception-effort\');"  required="" > Non </label>
									<label for="default" class="btn btn-default"><input type="radio" id="APL1" name="APL1"  value="5" onchange="masquer_div(\'freq-activite\');masquer_div(\'min-act\');masquer_div(\'perception-effort\');"> Oui </label>';
								}
								...
								<tr>
								<td>
								<div class="form-group" id="min-act">
								...
								<tr>
								<td>
								<div class="form-group" id="perception-effort">
								...
								<div class="col-md-8">
									...
									<?php 
								if($RG_APQ1 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ1" name="APQ1"  value="1" selected  required="" > Légère </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ1" name="APQ1"  value="1"  required="" > Légère </label>
								...
								<div class="col-md-8">
									...
									<?php 
								if($RG_APQ2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ2" name="APQ2"  value="1" selected  required="" > Moins de 2h </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ2" name="APQ2"  value="1"  required="" > Moins de 2h </label>
								...
								<div class="col-md-8">
									...
									<?php 
								if($RG_APQ3 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ3" name="APQ3"  value="1" selected  required="" > Moins de 15 min </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ3" name="APQ3"  value="1"  required="" > Moins de 15 min </label>
								...
								<div class="col-md-8">
									...
									<?php 
								if($RG_APQ4 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ4" name="APQ4"  value="1" selected  required="" > Moins de 2 </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ4" name="APQ4"  value="1"  required="" > Moins de 2 </label>
