<h4>Evaluation Ricci & Gagnon </h4> 
								...
								<div class="form-group">
								  <label class="col-md-4 control-label" >Combien de temps passez-vous en position assise par jour (loisirs, télé, ordinateur, travail, etc…) <span style="color: red">*</span></label>  
								<div class="col-md-8">
								<?php 
								if($RG_CS2 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="CS1-2" name="CS1-2"  value="1" selected  required="" > + 5h </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="CS1-2" name="CS1-2"  value="1"  required="" > + 5h </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Pratiquez vous régulièrement une ou des activités physiques ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									<?php 
									if($RG_APL12 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL1-2" name="APL1-2"  value="1" selected onchange="masquer_div(\'freq-activite2\');masquer_div(\'min-act2\');masquer_div(\'perception-effort2\');"  required="" > Non </label>
									<label for="default" class="btn btn-default"><input type="radio" id="APL1-2" name="APL1-2"  value="5" onchange="masquer_div(\'freq-activite2\');masquer_div(\'min-act2\');masquer_div(\'perception-effort2\');"> Oui </label>';
								} else if($RG_APL12 == 5){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL1-2" name="APL1-2"  value="1" onchange="masquer_div(\'freq-activite2\');masquer_div(\'min-act2\');masquer_div(\'perception-effort2\');"  required="" > Non </label>
									<label for="default" class="btn btn-default"><input type="radio" id="APL1-2" name="APL1-2"  value="5" selected onchange="masquer_div(\'freq-activite2\');masquer_div(\'min-act2\');masquer_div(\'perception-effort2\');"> Oui </label>';
								} else {
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL1-2" name="APL1-2"  value="1" onchange="masquer_div(\'freq-activite2\');masquer_div(\'min-act2\');masquer_div(\'perception-effort2\');"  required="" > Non </label>
									<label for="default" class="btn btn-default"><input type="radio" id="APL1-2" name="APL1-2"  value="5" onchange="masquer_div(\'freq-activite2\');masquer_div(\'min-act2\');masquer_div(\'perception-effort2\');"> Oui </label>';
								}
								...
								<tr>
								<td>
								<div class="form-group" id="freq-activite2">
								  <label class="col-md-4 control-label" >A quelle fréquence pratiquez-vous l'ensemble de ces activités ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
								<?php 
								if($RG_APL22 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL2-2-2" name="APL2-2"  value="1" selected  required="" > 1 à 2 x/mois </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL2-2" name="APL2-2"  value="1"  required="" > 1 à 2 x/mois </label>
								...
								<tr>
								<td>
								<div class="form-group" id="min-act2">
								  <label class="col-md-4 control-label" >Combien de minutes consacrez-vous en moyenne à chaque séance d'activité ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
								<?php 
								if($RG_APL32 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL3-2" name="APL3-2"  value="1" selected  required="" > Moins de 15 min </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL3-2" name="APL3-2"  value="1"  required="" > Moins de 15 min </label>
								...
								<tr>
								<td>
								<div class="form-group" id="perception-effort2">
								  <label class="col-md-4 control-label" >Habituellement comment percevez-vous votre effort ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($RG_APL42 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL4-2" name="APL4-2"  value="1" selected  required="" > Très facile </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APL4-2" name="APL4-2"  value="1"  required="" > Très facile </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Quelle intensité d'activité physique votre travail requiert t-il ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($RG_APQ12 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ1-2" name="APQ1-2"  value="1" selected  required="" > Légère </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ1-2" name="APQ1-2"  value="1"  required="" > Légère </label>
								...
								<div class="form-group" id="freq-activite">
								  <label class="col-md-4 control-label" >En dehors de votre travail régulier, combien d'heures par semaines consacrez-vous aux travaux légers ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($RG_APQ22 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ2-2" name="APQ2-2"  value="1" selected  required="" > Moins de 2h </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ2-2" name="APQ2-2"  value="1"  required="" > Moins de 2h </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Combien de minutes consacrez-vous à la marche ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($RG_APQ32 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ3-2" name="APQ3-2"  value="1" selected  required="" > Moins de 15 min </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ3-2" name="APQ3-2"  value="1"  required="" > Moins de 15 min </label>
								...
								<td>
								<div class="form-group">
								  <label class="col-md-4 control-label" >Combien d'étages en moyenne montez-vous à pieds chaque jour ? <span style="color: red">*</span></label>  
								<div class="col-md-8">
									
									<?php 
								if($RG_APQ42 == 1){
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ4-2" name="APQ4-2"  value="1" selected  required="" > Moins de 2 </label>
									...
									echo'<label for="default" class="btn btn-default"><input type="radio" id="APQ4-2" name="APQ4-2"  value="1"  required="" > Moins de 2 </label>
