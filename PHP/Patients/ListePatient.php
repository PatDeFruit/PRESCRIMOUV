        ...
        <div id="conteneurPrincipale">
			<div id="conteneurTotal">
				<fieldset id="conteneurInterieur">
					<center><legend><a href="../Accueil.php" style="color: white; margin-right: 50px;"><span class="glyphicon glyphicon-arrow-left"></span></a>Liste des bénéficiaires</center></legend>
					<center>
							...
							<?php
								...
								while($data=$query->fetch()){
									...
									if($data['id_statut']==1 || $data['id_statut']==2 || $data['id_statut']==3){
										...
										echo'</td><td class="text-center" width="30%"><a class=\'btn btn-success btn-xs\' href="AfficherPatient.php?idPatient='.$data['id_patient'].'&statutPatient='.$data['statut'].'"><span class="glyphicon glyphicon-eye-open"></span> </a></td>';
									}
								}
