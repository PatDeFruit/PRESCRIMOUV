<table class="table">
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="activitePhys" name="activitePhys" value="'.$apActuelle1.'" class="form-control input-md"   required="" type="text">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="APante" name="APante" value="'.$apAnterieure1.'" class="form-control input-md"   required="" type="text">';
								  ?>
								...
								<!-- Text input-->
								<div class="form-group">
								  <label class="col-md-2 control-label" >Freins</label>  
								<div class="col-md-8">
								<?php
								...
								<!-- Text input-->
									<div class="form-group">
								  <label class="col-md-2 control-label" >Attentes et motivations</label>
								<div class="col-md-8">
								<?php
								...
								<!-- Text input-->
									<div class="form-group">
								  <label class="col-md-2 control-label" >Objectifs généraux</label>
								<div class="col-md-8">
								<?php
