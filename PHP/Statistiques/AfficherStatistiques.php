        ...
        <div id="conteneurPrincipale">
			<div id="conteneurTotal">
				<fieldset id="conteneurInterieur">
					<center><legend><a href="../Accueil.php" style="color: white; margin-right: 50px;"><span class="glyphicon glyphicon-arrow-left"></span></a>Statistiques détaillées</center></legend>
					<br/><center>
						...
						<?php  
							...
							for($i=0; $i<sizeof($arrayStat2); $i++){
							 ...
							 echo'<img src="benefInitPatho.png" />';
							  // Initialise the graph  
								$MiniGraph3 = new pChart(120,100);  
								$MiniGraph3->setFontProperties("Fonts/tahoma.ttf",8);  
								  
								// Draw the line graph  
								$MiniGraph3->drawFlatPieGraphWithShadow($DataSet3->GetData(),$DataSet3->GetDataDescription(),75,50,10); 
								  
								// Finish the graph  
								$MiniGraph3->Render("SmallGraphInitialPatho.png");  
							}
							if($arrayStat3!= array()){
								// Dataset definition   
							 $DataSet4 = new pData;  
							...
							for($i=0; $i<sizeof($arrayStat3); $i++){
							 ...
							 // Initialise the graph  
								$MiniGraph4 = new pChart(120,100);  
								$MiniGraph4->setFontProperties("Fonts/tahoma.ttf",8);  
								  
								// Draw the line graph  
								$MiniGraph4->drawFlatPieGraphWithShadow($DataSet4->GetData(),$DataSet4->GetDataDescription(),75,50,10); 
								  
								// Finish the graph  
								$MiniGraph4->Render("SmallGraphInterPatho.png");  
							}
							if($arrayStat4!= array()){
								// Dataset definition   
							 $DataSet5 = new pData;  
							...
							for($i=0; $i<sizeof($arrayStat4); $i++){
							 ...
							 // Initialise the graph  
								$MiniGraph5 = new pChart(120,100);  
								$MiniGraph5->setFontProperties("Fonts/tahoma.ttf",8);  
								  
								// Draw the line graph  
								$MiniGraph5->drawFlatPieGraphWithShadow($DataSet5->GetData(),$DataSet5->GetDataDescription(),75,50,10); 
								  
								// Finish the graph  
								$MiniGraph5->Render("SmallGraphFinalPatho.png");  
							}
							if($arrayStat6!= array()){
								// Dataset definition   
							 $DataSet6 = new pData;  
							...
							for($i=0; $i<sizeof($arrayStat6); $i++){
							 ...
							 // Initialise the graph  
								$MiniGraph6 = new pChart(120,100);  
								$MiniGraph6->setFontProperties("Fonts/tahoma.ttf",8);  
								  
								// Draw the line graph  
								$MiniGraph6->drawFlatPieGraphWithShadow($DataSet6->GetData(),$DataSet6->GetDataDescription(),75,50,10); 
								  
								// Finish the graph  
								$MiniGraph6->Render("SmallGraphArchivePatho.png");  
							}
							?>  					
