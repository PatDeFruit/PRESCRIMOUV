							 ...
							 <div class="row">
							  ...
							  <div class="tab-content">
							   <div id="ficheResume" class="tab-pane fade active in">
								...
								<?php
								echo'<input type="submit" class=\'btn btn-success btn-xs\' ">';
								?>
								</br>
								</br>
								</form>
							   ...
							   <div id="infoPatient" class="tab-pane fade">
								...
								<div class="form-group">
								  ...
								  <div class="col-md-2">
								  <?php
								  echo'<input id="nbEnfant" name="nbEnfant" value="'.$enfantPatient.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-8">
								  <?php
								  echo'<input id="profession" name="profession" value="'.$profPatient.'" class="form-control input-md"   required="" type="text">';
								  ?>
								...
								<?php
								echo'<input type="submit" value="Enregistrer les changements" class=\'btn btn-success btn-xs\' ">';
								?>
								</br>
								</br>
								</form>
							   ...
							   ?>
								...
								$newIMCinit = $_POST['imc1'];
								$newMassH = $_POST['massH1'];
								$newMassG = $_POST['massG1'];
								$newMassM = $_POST['messM1'];
								$newFCInit = $_POST['RCrepos1'];
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="IMC1" name="IMC1" value="'.$imc1.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
									echo '<input id="massH1" name="massH1" value="'.$mhydrique1.'" class="form-control input-md" required=""   type="number">';
									?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="massG1" name="massG1" value="'.$mgrasse1.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="massM1" name="massM1" value="'.$mmuscu1.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="col-md-8">
									<label for="default" class="btn btn-default"><input type="radio" id="CS1" name="CS1"  value="1"> + 5h </label>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="dateTM1" name="dateTM1" value="'.$dateTM.'" class="form-control input-md"   required="" type="date">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="aideTM1" name="aideTM1" value="'.$aideMarche.'" class="form-control input-md"   required="" type="text">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="FCavantTM1" name="FCavantTM1" value="'.$FC_avant.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="FCapresTM1" name="FCapresTM1" value="'.$FC_fin.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="FC1minTM1" name="FC1minTM1" value="'.$FC_1min.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="FC2minTM1" name="FC2minTM1" value="'.$FC_2min.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="SPavantTM1" name="SPavantTM1" value="'.$SPO2_avant.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="SPapresTM1" name="SPapresTM1" value="'.$SPO2_fin.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="SP1minTM1" name="SP1minTM1" value="'.$SPO2_1min.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="SP2minTM1" name="SP2minTM1" value="'.$SPO2_2min.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="BorgavantTM1" name="BorgavantTM1" value="'.$Borg_avant.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="BorgapresTM1" name="BorgapresTM1" value="'.$Borg_fin.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="Borg1minTM1" name="Borg1minTM1" value="'.$Borg_1min.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="Borg2minTM1" name="Borg2minTM1" value="'.$Borg_2min.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="DistRelleTM1" name="DistRelleTM1" value="'.$distReelle.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="NbArretTM1" name="NbArretTM1" value="'.$nbArret.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="FreqCard1" name="FreqCard1" value="'.$FCfinAD.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="FreqCard2" name="FreqCard2" value="'.$FC2minAD.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input type="range" name="nivAPactu" id="nivAPactu" min="0" max="10" value="'.$nivAP1.'"  class="form-control input-md"   onchange="rangePrimary.value=value">';
									  ?>
									  </div>
									  <div class="col-md-2">
									  <?php
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="activitePhys" name="activitePhys" value="'.$apActuelle1.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<!-- Text input-->
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input type="range" name="nivCS" id="nivCS" min="0" max="10" value="'.$nivCS1.'"  class="form-control input-md"   onchange="rangePrimary3.value=value">';
									  ?>
									  </div>
									  <div class="col-md-2">
									  <?php
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="APante" name="APante" value="'.$apAnterieure1.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input type="range" name="nivAPenvisagee" id="nivAPenvisagee" min="0" max="10" value="'.$nivAPvoulue1.'"    class="form-control input-md" onchange="rangePrimary2.value=value">';
									  ?>
									  </div>
									  <div class="col-md-2">
									  <?php
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								 echo'<input id="centre" name="centre" value="'.$data['nom_centre'].'" class="form-control input-md"   required="" type="text">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <?php
								 echo'
								  <input id="typeAct" name="typeAct" value="'.$data['type_activite'].'" class="form-control input-md"   required="" type="text">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-3">
								  <?php
								 echo'<input id="creneau" name="creneau" value="'.$data['jour_creneau'].' de '.$data['heure_creneau_debut'].' à '.$data['heure_creneau_fin'].'" class="form-control input-md"   required="" type="text">';
								?>
								  </div>
								</div>			
								</td>
							   ...
							   <div id="entInter" class="tab-pane fade">
								...
								<!-- Text input-->
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input type="range" name="nivAP3mois" id="nivAP3mois" min="0" max="10" value="'.$nivAP2.'"    class="form-control input-md" onchange="rangePrimary3.value=value">';
									  ?>
									  </div>
									  <div class="col-md-2">
									  <?php
							   ...
							   <div id="entFinal" class="tab-pane fade">
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="IMC2" name="IMC2" value="'.$imc3.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="scoreCS2" name="scoreCS2" value="'.$scoreCS3.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="scoreAPL2" name="scoreAPL2" value="'.$scoreAPL3.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="scoreAPQ2" name="scoreAPQ2" value="'.$scoreAPQ3.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="scoreRG2" name="scoreRG2" value="'.$scoreRG3.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="DistTheoTM2" name="DistTheoTM2" value="'.$distTheo2.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="PourcTheoTM2" name="PourcTheoTM2" value="'.$pourTheo2.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>									
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="PiedDYO2" name="PiedDYO2" value="'.$tempsPDYO2.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="PiedDYF2" name="PiedDYF2" value="'.$tempsPDYF2.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="PiedGYO2" name="PiedGYO2" value="'.$tempsPGYO2.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="PiedGYF2" name="PiedGYF2" value="'.$tempsPGYF2.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="scoreQDV2" name="scoreQDV2" value="'.$scoreQDV2.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="scoreSP2" name="scoreSP2" value="'.$scorePHY2.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="scoreSPsy2" name="scoreSPsy2" value="'.$scorePSY2.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="scoreR2" name="scoreR2" value="'.$scoreREL2.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="scoreE2" name="scoreE2" value="'.$scoreENV2.'" class="form-control input-md"   required="" type="number">';
								  ?>
							   ...
							   <div id="bilan" class="tab-pane fade">
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
									echo '<input id="Deltataille" name="Deltataille" value="'.$deltaTaille.'" class="form-control input-md" required=""   type="number">';
									?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="DeltaPoids" name="DeltaPoids" value="'.$deltaPoids.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="DeltaIMC" name="DeltaIMC" value="'.$deltaIMC.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
									echo '<input id="DeltaMH" name="DeltaMH" value="'.$deltaMH.'" class="form-control input-md" required=""   type="number">';
									?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="DeltaMG" name="DeltaMG" value="'.$deltaMG.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="DeltaMM" name="DeltaMM" value="'.$deltaMM.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
									echo '<input id="DeltaFC" name="DeltaFC" value="'.$deltaFC.'" class="form-control input-md" required=""   type="number">';
									?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="DeltaSP" name="DeltaSP" value="'.$deltaSP.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="deltaAP" name="deltaAP" value="'.$deltaAP.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="deltaCS" name="deltaCS" value="'.$deltaCS.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="DeltaRG" name="DeltaRG" value="'.$deltaRG.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="DeltaDistRelleTM" name="DeltaDistRelleTM" value="'.$deltaTDMDist.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="DeltaPourcTheoTM" name="DeltaPourcTheoTM" value="'.$deltaTDMPour.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>									
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="DeltaPiedDYO" name="DeltaPiedDYO" value="'.$deltaPDYO.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="DeltaPiedDYF" name="DeltaPiedDYF" value="'.$deltaPDYF.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="DeltaPiedGYO" name="DeltaPiedGYO" value="'.$deltaPGYO.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="DeltaPiedGYF" name="DeltaPiedGYF" value="'.$deltaPGYF.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<tr>
									...
									<div class="form-group">
									  ...
									  <div class="col-md-4">
									  <?php
									  echo'<input id="DeltaNbRepet" name="DeltaNbRepet" value="'.$deltaADrepet.'" class="form-control input-md"   required="" type="number">';
									  ?>
									  </div>
									</div>
									</td>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="deltaQDV" name="deltaQDV" value="'.$deltaQDV.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="deltaSP" name="deltaSP" value="'.$deltaPhy.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="deltaSPsy" name="deltaSPsy" value="'.$deltaPsy.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="deltaR" name="deltaR" value="'.$deltaRel.'" class="form-control input-md"   required="" type="number">';
								  ?>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4">
								  <?php
								  echo'<input id="deltaEnv" name="deltaEnv" value="'.$deltaEnvi.'" class="form-control input-md"   required="" type="number">';
								  ?>
